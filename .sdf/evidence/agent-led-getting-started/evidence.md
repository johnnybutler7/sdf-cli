...
small public entry-point copy in `README.md`. A follow-up clarification makes
the copyable prompt point to the canonical GitHub guide URL so it works from a
receiver repository where `GETTING-STARTED.md` is not local.
...
Confirm the canonical guide URL in the copyable prompt, pinned PyPI
instructions, and manual walkthrough remain accurate.
...
branch:
  ...
  head: "8e1e1991185c1867ab4503b208ccd6a037431482"
run_context:
  surface: "unknown"
  model: "unknown"
  reasoning: "unknown"
...
closed_at: "2026-07-26T07:31:18+00:00"
