...
## Repo-Local Dogfood Activation

For governed changes in this repository, create a new
`.sdf/evidence/<change-id>/` archive and use the configured repository checks
for closeout. Historical archives are intentionally absent from this baseline.
